...
const imageLink = [
  ...
  "./portfolio/outdoor shop/index.html",
  "#", //このサイト
  "./portfolio.html#design-skills", //コーヒー宅急便のデザイン
  "./portfolio.html#design-skills", //美容室Lのデザイン
  "./portfolio/spotify 模写/index.html",
  "./portfolio/iSara 模写/index.html",
  "./portfolio/ニセコ・白雲荘 模写/index.html",
  "./portfolio/スマホサイト・AGT 模写/index.html",
  "./portfolio/メルカリ 模写/index.html"
]
const imageShift = ()=>{
  $hexgonInnerImage.eq(indexBefor).removeClass('selected');
  $hexgonInnerImage.eq(indexAfter).addClass('selected');
  indexBefor = indexAfter;
  $('#portfolio a.hexagon').attr("href",imageLink[indexBefor]);
...
const designImage = [
  "./portfolio/珈琲宅急便/coffee_takkyubin.png",
  "./portfolio/美容室 L/Main – 1.png"
]
...
$('ul#design-skills > li').find('.hexagon__inner-image').click(function(){
  ...
  $('.image-wrapper img').attr('src',designImage[designIndex]);
